...
var stopsUrl = "https://raw.githubusercontent.com/geogr-muni/eurocarto-map/refs/heads/main/zastavky2.geojson";
var linesUrl = "https://raw.githubusercontent.com/geogr-muni/eurocarto-map/refs/heads/main/linky.geojson";
...
function getLinesColor(property) {
    switch (property) {
        case 'T12': return '#558e90';
        case 'TB26': return '#426E70';
        case 'TB25': return '#426E70';
    ...
    .then(data => {
        L.geoJSON(data, {
            style: function (feature) {
                return {
                    color: getLinesColor(feature.properties.naz_linky),
                    weight: 2
                };
            }
        }).addTo(transportLayer);
...
function getStopColor(property) {
    switch (property) {
        case '12': return '#558e90';
        case '25/26': return '#426E70';
        default: return '#ff7f00';
    }
};
        ...
        L.geoJSON(data, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    radius: 6,
                    fillColor: getStopColor(feature.properties.linka_c),
                    color: "#ffffff",
                    weight: 1,
                    opacity: 1,
                    fillOpacity: 0.8
            ...
            onEachFeature: function (feature, layer) {
                layer.bindPopup(`<b>Stop: ${feature.properties.name}</b><br>Line: ${feature.properties.linka_c}`, { className: 'transparent-popup', closeButton: false });
            }
        }).addTo(transportLayer); // Add to the SAME group
    });
